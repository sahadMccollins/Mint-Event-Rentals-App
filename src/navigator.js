...
import GallerySingle from './screens/gallery/gallerySingle';
    ...
    return (
        <NavigationContainer theme={theme}>
            <Stack.Navigator
                ...
                <Stack.Screen name="Gallery" component={Gallery} initialParams={{ t }} />
                <Stack.Screen name="GallerySingle" component={GallerySingle} initialParams={{ t }} />
                <Stack.Screen
                    name="TermsCondition"
