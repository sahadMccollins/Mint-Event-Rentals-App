    ...
    <View style={styles.container}>
      ...
      <View style={{ marginVertical: windowHeight(10) }} >
        {bulletPoints.map((item, index) => (
          <View key={index} style={[styles.row, viewRTLStyle]}>
            <View style={styles.circle} />
            <Text style={[styles.discription, textRTLStyle]}>
              {item}
            </Text>
          </View>
        ))}
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: windowHeight(10) }} >
        <Text style={[styles.subTitle, { color: colors.text }, textRTLStyle]}>Category</Text>
        <Text style={[styles.subTitle, { color: colors.text }, textRTLStyle]}>Categories of Recipients</Text>
      </View>
      <View style={{ height: windowHeight(1), backgroundColor: '#dedede', marginVertical: windowHeight(10) }} />
      <View style={{ flexDirection: 'row', justifyContent: 'space-between' }} >
        <View style={{ width: windowWidth(200), marginBottom: windowHeight(10) }}>
          <View style={[styles.row, viewRTLStyle]}>
            <View style={styles.circle} />
            <Text style={[styles.discription, textRTLStyle]}>
      ...
      <Text style={[styles.content, textRTLStyle]}>
        Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at sk@minteventrentals.com or contact us at Mint Event Rentals, Dubai, DU, AE.
      </Text>
    </View>
  );
};
